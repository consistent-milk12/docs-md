...
*Defined in [`serde_core-1.0.228/src/ser/impossible.rs:66`](../../../../.source_1765521767/serde_core-1.0.228/src/ser/impossible.rs#L66)*

#### Trait Implementations

##### `impl Any for Void`

- <span id="void-any-type-id"></span>`fn type_id(&self) -> TypeId`

##### `impl<T> Borrow for Void`

- <span id="void-borrow"></span>`fn borrow(&self) -> &T`

##### `impl<T> BorrowMut for Void`

- <span id="void-borrowmut-borrow-mut"></span>`fn borrow_mut(&mut self) -> &mut T`

##### `impl<T> From for Void`

- <span id="void-from"></span>`fn from(t: T) -> T`

  Returns the argument unchanged.

##### `impl<U> Into for Void`
...
- <span id="void-tryfrom-type-error"></span>`type Error = Infallible`

- <span id="void-tryfrom-try-from"></span>`fn try_from(value: U) -> Result<T, <T as TryFrom>::Error>`

##### `impl<U> TryInto for Void`

- <span id="void-tryinto-type-error"></span>`type Error = <U as TryFrom>::Error`

- <span id="void-tryinto-try-into"></span>`fn try_into(self) -> Result<U, <U as TryFrom>::Error>`
