...
- <span id="u8-indexmut-index-mut"></span>`fn index_mut(&mut self, index: Span) -> &mut [u8]` — [`Span`](../../index.md#span)
...
- <span id="span-partialeq-eq"></span>`fn eq(&self, other: &Span) -> bool` — [`Span`](../../index.md#span)
...
- <span id="halfmatch-partialeq-eq"></span>`fn eq(&self, other: &HalfMatch) -> bool` — [`HalfMatch`](../../index.md#halfmatch)
...
- <span id="match-partialeq-eq"></span>`fn eq(&self, other: &Match) -> bool` — [`Match`](../../index.md#match)
...
- <span id="patternset-partialeq-eq"></span>`fn eq(&self, other: &PatternSet) -> bool` — [`PatternSet`](../../index.md#patternset)
...
- <span id="patternsetiter-doubleendediterator-next-back"></span>`fn next_back(&mut self) -> Option<PatternID>` — [`PatternID`](../primitives/index.md#patternid)
...
- <span id="patternsetiter-iterator-next"></span>`fn next(&mut self) -> Option<PatternID>` — [`PatternID`](../primitives/index.md#patternid)
...
- <span id="matcherror-partialeq-eq"></span>`fn eq(&self, other: &MatchError) -> bool` — [`MatchError`](../../index.md#matcherror)
...
- <span id="anchored-partialeq-eq"></span>`fn eq(&self, other: &Anchored) -> bool` — [`Anchored`](../../index.md#anchored)
...
- <span id="matchkind-partialeq-eq"></span>`fn eq(&self, other: &MatchKind) -> bool` — [`MatchKind`](../../index.md#matchkind)
...
- <span id="matcherrorkind-partialeq-eq"></span>`fn eq(&self, other: &MatchErrorKind) -> bool` — [`MatchErrorKind`](../../index.md#matcherrorkind)
