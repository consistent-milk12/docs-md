*[regex_automata](../../index.md) / [util](../index.md) / [empty](index.md)*
...
```rust
fn skip_splits_fwd<T, F>(input: &crate::util::search::Input<'_>, init_value: T, match_offset: usize, find: F) -> Result<Option<T>, crate::util::search::MatchError>
where
    F: FnMut(&crate::util::search::Input<'_>) -> Result<Option<(T, usize)>, crate::util::search::MatchError>
```

*Defined in [`regex-automata-0.4.13/src/util/empty.rs:161-171`](../../../../.source_1765521767/regex-automata-0.4.13/src/util/empty.rs#L161-L171)*

### `skip_splits_rev`

```rust
fn skip_splits_rev<T, F>(input: &crate::util::search::Input<'_>, init_value: T, match_offset: usize, find: F) -> Result<Option<T>, crate::util::search::MatchError>
where
    F: FnMut(&crate::util::search::Input<'_>) -> Result<Option<(T, usize)>, crate::util::search::MatchError>
```

*Defined in [`regex-automata-0.4.13/src/util/empty.rs:175-185`](../../../../.source_1765521767/regex-automata-0.4.13/src/util/empty.rs#L175-L185)*

### `skip_splits`

```rust
fn skip_splits<T, F>(forward: bool, input: &crate::util::search::Input<'_>, init_value: T, match_offset: usize, find: F) -> Result<Option<T>, crate::util::search::MatchError>
where
    F: FnMut(&crate::util::search::Input<'_>) -> Result<Option<(T, usize)>, crate::util::search::MatchError>
```

*Defined in [`regex-automata-0.4.13/src/util/empty.rs:187-265`](../../../../.source_1765521767/regex-automata-0.4.13/src/util/empty.rs#L187-L265)*
