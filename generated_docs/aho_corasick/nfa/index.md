*[aho_corasick](../index.md) / [nfa](index.md)*
...
* A [`noncontiguous::NFA`](noncontiguous/index.md) uses a separate allocation for every NFA state to
...
* A [`contiguous::NFA`](contiguous/index.md) is uses a single allocation to represent all states,
