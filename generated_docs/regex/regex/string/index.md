...
- `fn new(haystack: &'h str, start: usize, end: usize) -> Match<'h>` — [`Match`](../../index.md)

#### Trait Implementations

##### `impl<'h> Clone for Match<'h>`

- `fn clone(self: &Self) -> Match<'h>` — [`Match`](../../index.md)
...
- `fn eq(self: &Self, other: &Match<'h>) -> bool` — [`Match`](../../index.md)
...
- `fn get(self: &Self, i: usize) -> Option<Match<'h>>` — [`Match`](../../index.md)

- `fn get_match(self: &Self) -> Match<'h>` — [`Match`](../../index.md)

- `fn name(self: &Self, name: &str) -> Option<Match<'h>>` — [`Match`](../../index.md)

- `fn extract<const N: usize>(self: &Self) -> (&'h str, [&'h str; N])`

- `fn expand(self: &Self, replacement: &str, dst: &mut String)`

- `fn iter<'c>(self: &'c Self) -> SubCaptureMatches<'c, 'h>` — [`SubCaptureMatches`](../../index.md)
...
- `fn clone(self: &Self) -> CaptureLocations` — [`CaptureLocations`](../../index.md)
...
- `fn next(self: &mut Self) -> Option<Match<'h>>` — [`Match`](../../index.md)
...
- `fn next(self: &mut Self) -> Option<Captures<'h>>` — [`Captures`](../../index.md)
...
- `fn clone(self: &Self) -> CaptureNames<'r>` — [`CaptureNames`](../../index.md)
...
- `fn clone(self: &Self) -> SubCaptureMatches<'c, 'h>` — [`SubCaptureMatches`](../../index.md)
...
- `fn next(self: &mut Self) -> Option<Option<Match<'h>>>` — [`Match`](../../index.md)
...
- `fn replace_append(self: &mut Self, caps: &Captures<'_>, dst: &mut String)` — [`Captures`](../../index.md)
...
- `fn clone(self: &Self) -> NoExpand<'s>` — [`NoExpand`](../../index.md)
...
- `fn replace_append(self: &mut Self, _: &Captures<'_>, dst: &mut String)` — [`Captures`](../../index.md)
