...
- <span id="vec-target"></span>`type Target = [T]`
...
- <span id="vec-output"></span>`type Output = <I as SliceIndex>::Output`
...
- <span id="vec-item"></span>`type Item = T`

- <span id="vec-intoiter"></span>`type IntoIter = IntoIter<T, A>`
