...
- <span id="inputmodes-flags-from-bits-retain"></span>`fn from_bits_retain(bits: ffi::c_uint) -> InputModes` — [`c_uint`](../../ffi/index.md#c-uint), [`InputModes`](../index.md#inputmodes)
...
- <span id="inputmodes-partialeq-eq"></span>`fn eq(&self, other: &InputModes) -> bool` — [`InputModes`](../index.md#inputmodes)
...
- <span id="outputmodes-flags-from-bits-retain"></span>`fn from_bits_retain(bits: ffi::c_uint) -> OutputModes` — [`c_uint`](../../ffi/index.md#c-uint), [`OutputModes`](../index.md#outputmodes)
...
- <span id="outputmodes-partialeq-eq"></span>`fn eq(&self, other: &OutputModes) -> bool` — [`OutputModes`](../index.md#outputmodes)
...
- <span id="controlmodes-flags-from-bits-retain"></span>`fn from_bits_retain(bits: ffi::c_uint) -> ControlModes` — [`c_uint`](../../ffi/index.md#c-uint), [`ControlModes`](../index.md#controlmodes)
...
- <span id="controlmodes-partialeq-eq"></span>`fn eq(&self, other: &ControlModes) -> bool` — [`ControlModes`](../index.md#controlmodes)
...
- <span id="localmodes-flags-from-bits-retain"></span>`fn from_bits_retain(bits: ffi::c_uint) -> LocalModes` — [`c_uint`](../../ffi/index.md#c-uint), [`LocalModes`](../index.md#localmodes)
...
- <span id="localmodes-partialeq-eq"></span>`fn eq(&self, other: &LocalModes) -> bool` — [`LocalModes`](../index.md#localmodes)
...
- <span id="specialcodes-indexmut-index-mut"></span>`fn index_mut(&mut self, index: SpecialCodeIndex) -> &mut <Self as >::Output` — [`SpecialCodeIndex`](../index.md#specialcodeindex)
...
- <span id="specialcodeindex-partialeq-eq"></span>`fn eq(&self, other: &SpecialCodeIndex) -> bool` — [`SpecialCodeIndex`](../index.md#specialcodeindex)
...
- <span id="winsize-partialeq-eq"></span>`fn eq(&self, other: &Winsize) -> bool` — [`Winsize`](../index.md#winsize)
...
- <span id="optionalactions-partialeq-eq"></span>`fn eq(&self, other: &OptionalActions) -> bool` — [`OptionalActions`](../index.md#optionalactions)
...
- <span id="queueselector-partialeq-eq"></span>`fn eq(&self, other: &QueueSelector) -> bool` — [`QueueSelector`](../index.md#queueselector)
...
- <span id="action-partialeq-eq"></span>`fn eq(&self, other: &Action) -> bool` — [`Action`](../index.md#action)
