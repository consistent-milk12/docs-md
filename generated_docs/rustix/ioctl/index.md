...
- <span id="noarg-ioctl-opcode"></span>`fn opcode(&self) -> self::Opcode` — [`Opcode`](#opcode)

- <span id="noarg-ioctl-as-ptr"></span>`fn as_ptr(&mut self) -> *mut c::c_void`

- <span id="noarg-ioctl-output-from-ptr"></span>`unsafe fn output_from_ptr(_: IoctlOutput, _: *mut c::c_void) -> Result<<Self as >::Output>` — [`IoctlOutput`](#ioctloutput), [`Result`](../io/errno/index.md#result), [`Ioctl`](#ioctl)
...
- <span id="getter-ioctl-opcode"></span>`fn opcode(&self) -> self::Opcode` — [`Opcode`](#opcode)

- <span id="getter-ioctl-as-ptr"></span>`fn as_ptr(&mut self) -> *mut c::c_void`

- <span id="getter-ioctl-output-from-ptr"></span>`unsafe fn output_from_ptr(_: IoctlOutput, ptr: *mut c::c_void) -> Result<<Self as >::Output>` — [`IoctlOutput`](#ioctloutput), [`Result`](../io/errno/index.md#result), [`Ioctl`](#ioctl)
...
- <span id="setter-ioctl-opcode"></span>`fn opcode(&self) -> self::Opcode` — [`Opcode`](#opcode)

- <span id="setter-ioctl-as-ptr"></span>`fn as_ptr(&mut self) -> *mut c::c_void`

- <span id="setter-ioctl-output-from-ptr"></span>`unsafe fn output_from_ptr(_: IoctlOutput, _: *mut c::c_void) -> Result<<Self as >::Output>` — [`IoctlOutput`](#ioctloutput), [`Result`](../io/errno/index.md#result), [`Ioctl`](#ioctl)
...
- <span id="updater-ioctl-opcode"></span>`fn opcode(&self) -> self::Opcode` — [`Opcode`](#opcode)

- <span id="updater-ioctl-as-ptr"></span>`fn as_ptr(&mut self) -> *mut c::c_void`

- <span id="updater-ioctl-output-from-ptr"></span>`unsafe fn output_from_ptr(_output: IoctlOutput, _ptr: *mut c::c_void) -> Result<()>` — [`IoctlOutput`](#ioctloutput), [`Result`](../io/errno/index.md#result)
...
- <span id="integersetter-ioctl-opcode"></span>`fn opcode(&self) -> self::Opcode` — [`Opcode`](#opcode)

- <span id="integersetter-ioctl-as-ptr"></span>`fn as_ptr(&mut self) -> *mut c::c_void`

- <span id="integersetter-ioctl-output-from-ptr"></span>`unsafe fn output_from_ptr(_out: IoctlOutput, _extract_output: *mut c::c_void) -> Result<<Self as >::Output>` — [`IoctlOutput`](#ioctloutput), [`Result`](../io/errno/index.md#result), [`Ioctl`](#ioctl)
...
*Defined in [`rustix-1.1.2/src/ioctl/mod.rs:271-283`](../../../.source_1765900590/rustix-1.1.2/src/ioctl/mod.rs#L271-L283)*
...
##### `impl Any for Direction`

- <span id="direction-any-type-id"></span>`fn type_id(&self) -> TypeId`

##### `impl<T> Borrow for Direction`

- <span id="direction-borrow"></span>`fn borrow(&self) -> &T`

##### `impl<T> BorrowMut for Direction`

- <span id="direction-borrowmut-borrow-mut"></span>`fn borrow_mut(&mut self) -> &mut T`

##### `impl Clone for Direction`

- <span id="direction-clone"></span>`fn clone(&self) -> Direction` — [`Direction`](#direction)

##### `impl CloneToUninit for Direction`

- <span id="direction-clonetouninit-clone-to-uninit"></span>`unsafe fn clone_to_uninit(&self, dest: *mut u8)`

##### `impl Copy for Direction`

##### `impl Debug for Direction`

- <span id="direction-debug-fmt"></span>`fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result`

##### `impl Eq for Direction`

##### `impl<T> From for Direction`

- <span id="direction-from"></span>`fn from(t: T) -> T`
...
- <span id="direction-ord-cmp"></span>`fn cmp(&self, other: &Direction) -> cmp::Ordering` — [`Direction`](#direction)

##### `impl PartialEq for Direction`

- <span id="direction-partialeq-eq"></span>`fn eq(&self, other: &Direction) -> bool` — [`Direction`](#direction)

##### `impl PartialOrd for Direction`

- <span id="direction-partialord-partial-cmp"></span>`fn partial_cmp(&self, other: &Direction) -> option::Option<cmp::Ordering>` — [`Direction`](#direction)

##### `impl StructuralPartialEq for Direction`

##### `impl ToOwned for Direction`

- <span id="direction-toowned-type-owned"></span>`type Owned = T`

- <span id="direction-toowned-to-owned"></span>`fn to_owned(&self) -> T`

- <span id="direction-toowned-clone-into"></span>`fn clone_into(&self, target: &mut T)`

##### `impl<U> TryFrom for Direction`

- <span id="direction-tryfrom-type-error"></span>`type Error = Infallible`

- <span id="direction-tryfrom-try-from"></span>`fn try_from(value: U) -> Result<T, <T as TryFrom>::Error>`

##### `impl<U> TryInto for Direction`

- <span id="direction-tryinto-type-error"></span>`type Error = <U as TryFrom>::Error`

- <span id="direction-tryinto-try-into"></span>`fn try_into(self) -> Result<U, <U as TryFrom>::Error>`
...
*Defined in [`rustix-1.1.2/src/ioctl/mod.rs:147-190`](../../../.source_1765900590/rustix-1.1.2/src/ioctl/mod.rs#L147-L190)*
...
- `fn Ioctl::as_ptr(&mut self) -> *mut c::c_void`

  Get a pointer to the data to be passed to the `ioctl` command.
  
  See trait-level documentation for more information.

- `fn Ioctl::output_from_ptr(out: IoctlOutput, extract_output: *mut c::c_void) -> Result<<Self as >::Output>`
...
*Defined in [`rustix-1.1.2/src/ioctl/mod.rs:91-107`](../../../.source_1765900590/rustix-1.1.2/src/ioctl/mod.rs#L91-L107)*
...
*Defined in [`rustix-1.1.2/src/ioctl/mod.rs:109-111`](../../../.source_1765900590/rustix-1.1.2/src/ioctl/mod.rs#L109-L111)*
...
*Defined in [`rustix-1.1.2/src/ioctl/mod.rs:113-119`](../../../.source_1765900590/rustix-1.1.2/src/ioctl/mod.rs#L113-L119)*
...
*Defined in [`rustix-1.1.2/src/ioctl/mod.rs:286`](../../../.source_1765900590/rustix-1.1.2/src/ioctl/mod.rs#L286)*
...
*Defined in [`rustix-1.1.2/src/ioctl/mod.rs:289`](../../../.source_1765900590/rustix-1.1.2/src/ioctl/mod.rs#L289)*
...
*Defined in [`rustix-1.1.2/src/ioctl/mod.rs:293`](../../../.source_1765900590/rustix-1.1.2/src/ioctl/mod.rs#L293)*
