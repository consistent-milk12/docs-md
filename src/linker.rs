...
mod tests {
    ...
    fn test_method_anchor_with_generics() {
        ...
        assert_eq!(method_anchor("Option<T>", "unwrap"), "option-unwrap");
    }

    /// Test: Method anchor with underscores.
    #[test]
    fn test_method_anchor_underscores() {
        assert_eq!(method_anchor("MyType", "my_method"), "mytype-my-method");
        assert_eq!(method_anchor("some_type", "do_thing"), "some-type-do-thing");
    }
