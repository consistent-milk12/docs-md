...
- `fn remove(self: Self) -> (T, VacantEntry<'a, T, A>)` — [`VacantEntry`](../hash_table/index.md)
...
- `fn clone(self: &Self) -> Iter<'a, T>` — [`Iter`](../hash_table/index.md)
...
- `fn clone(self: &Self) -> IterHash<'a, T>` — [`IterHash`](../hash_table/index.md)
...
- `fn or_insert(self: Self, default: T) -> OccupiedEntry<'a, T, A>` — [`OccupiedEntry`](../hash_table/index.md)

- `fn or_insert_with(self: Self, default: impl FnOnce() -> T) -> OccupiedEntry<'a, T, A>` — [`OccupiedEntry`](../hash_table/index.md)
