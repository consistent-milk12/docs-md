...
The primary trait for this is [`FileHeader`](../elf/file/index.md).

## High level API

[`XcoffFile`](file/index.md) implements the [`Object`](crate::read::Object) trait for XCOFF files.
[`XcoffFile`](file/index.md) is parameterised by [`FileHeader`](../elf/file/index.md) to allow reading both 32-bit and
64-bit XCOFF. There are type aliases for these parameters ([`XcoffFile32`](file/index.md) and
[`XcoffFile64`](file/index.md)).

## Low level API

The [`FileHeader`](../elf/file/index.md) trait can be directly used to parse both `xcoff::FileHeader32`
