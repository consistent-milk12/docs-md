...
|**Quick Links**|[`OwoColorize`](owo_colors/index.md)|[`Style`](#style)|[`StyledList`](#styledlist)|[`github`](https://github.com/owo-colors/owo-colors)|
|-|-|-|-|-|

---

This crate provides [`OwoColorize`](owo_colors/index.md), an extension trait for colorizing a
given type.
...
[`OwoColorize`](owo_colors/index.md).
...
A trait for describing a type which can be used with [`FgColorDisplay`](owo_colors/index.md) or
[`BgColorDisplay`](owo_colors/index.md)
...
A trait describing a runtime-configurable color which can displayed using [`FgDynColorDisplay`](owo_colors/index.md)
or [`BgDynColorDisplay`](owo_colors/index.md). If your color will be known at compile time it
