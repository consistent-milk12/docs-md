...
* [`PatternID`](regex_automata/util/primitives/index.md) - A type that represents the identifier of a regex pattern.
This is probably the most widely used type in this module (which is why it's
also re-exported in the crate root).
* [`StateID`](regex_automata/util/primitives/index.md) - A type the represents the identifier of a finite automaton
...
identifier.)
* [`SmallIndex`](regex_automata/util/primitives/index.md) - The internal representation of both a `PatternID` and a
...
* [`NonMaxUsize`](regex_automata/util/primitives/index.md) - Represents a `usize` that cannot be `usize::MAX`. As a
...
* [`PatternID`](regex_automata/util/primitives/index.md) is for representing the identifiers of patterns.
* [`StateID`](regex_automata/util/primitives/index.md) is for representing the identifiers of states in finite
...
[`SmallIndex`](regex_automata/util/primitives/index.md).
