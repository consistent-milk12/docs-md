...
count, then using `One::find` repeatedly. ([`OneIter`](../../sse2/memchr/index.md) specializes its
...
- `fn new(needle: u8) -> Option<One>` — [`One`](../../../../../arch/x86_64/avx2/memchr/index.md)

- `unsafe fn new_unchecked(needle: u8) -> One` — [`One`](../../../../../arch/x86_64/avx2/memchr/index.md)
...
- `fn iter<'a, 'h>(self: &'a Self, haystack: &'h [u8]) -> OneIter<'a, 'h>` — [`OneIter`](../../../../../arch/x86_64/avx2/memchr/index.md)

#### Trait Implementations

##### `impl Clone`

- `fn clone(self: &Self) -> One` — [`One`](../../../../../arch/x86_64/avx2/memchr/index.md)
...
- `fn clone(self: &Self) -> OneIter<'a, 'h>` — [`OneIter`](../../../../../arch/x86_64/avx2/memchr/index.md)
...
- `fn new(needle1: u8, needle2: u8) -> Option<Two>` — [`Two`](../../../../../arch/x86_64/avx2/memchr/index.md)

- `unsafe fn new_unchecked(needle1: u8, needle2: u8) -> Two` — [`Two`](../../../../../arch/x86_64/avx2/memchr/index.md)
...
- `fn iter<'a, 'h>(self: &'a Self, haystack: &'h [u8]) -> TwoIter<'a, 'h>` — [`TwoIter`](../../../../../arch/x86_64/avx2/memchr/index.md)

#### Trait Implementations

##### `impl Clone`

- `fn clone(self: &Self) -> Two` — [`Two`](../../../../../arch/x86_64/avx2/memchr/index.md)
...
- `fn clone(self: &Self) -> TwoIter<'a, 'h>` — [`TwoIter`](../../../../../arch/x86_64/avx2/memchr/index.md)
...
- `fn new(needle1: u8, needle2: u8, needle3: u8) -> Option<Three>` — [`Three`](../../../../../arch/x86_64/avx2/memchr/index.md)

- `unsafe fn new_unchecked(needle1: u8, needle2: u8, needle3: u8) -> Three` — [`Three`](../../../../../arch/x86_64/avx2/memchr/index.md)
...
- `fn iter<'a, 'h>(self: &'a Self, haystack: &'h [u8]) -> ThreeIter<'a, 'h>` — [`ThreeIter`](../../../../../arch/x86_64/avx2/memchr/index.md)

#### Trait Implementations

##### `impl Clone`

- `fn clone(self: &Self) -> Three` — [`Three`](../../../../../arch/x86_64/avx2/memchr/index.md)
...
- `fn clone(self: &Self) -> ThreeIter<'a, 'h>` — [`ThreeIter`](../../../../../arch/x86_64/avx2/memchr/index.md)
