...
The main types in this module are [`One`](../../x86_64/avx2/memchr/index.md), [`Two`](#two) and [`Three`](../../x86_64/avx2/memchr/index.md). They are for
...
* `'a` refers to the lifetime of the underlying [`Three`](../../x86_64/avx2/memchr/index.md) searcher.
* `'h` refers to the lifetime of the haystack being searched.
