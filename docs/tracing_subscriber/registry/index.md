...
Storage for span data shared by multiple [`Layer`](../fmt/fmt_layer/index.md)s.

## Using the Span Registry

This module provides the [`Registry`](sharded/index.md) type, a [`Subscriber`](../fmt/index.md) implementation
which tracks per-span data and exposes it to [`Layer`](../fmt/fmt_layer/index.md)s. When a `Registry`
is used as the base `Subscriber` of a `Layer` stack, the
[`layer::Context`][ctx] type will provide methods allowing `Layer`s to
[look up span data][`lookup`](../../addr2line/lookup/index.md) stored in the registry. While [`Registry`](sharded/index.md) is a
...
access to the [`Context`][ctx] methods, such as [`Context::span`][`lookup`](../../addr2line/lookup/index.md), that
...
implement this trait; if they do, any [`Layer`](../fmt/fmt_layer/index.md)s wrapping them can look up
