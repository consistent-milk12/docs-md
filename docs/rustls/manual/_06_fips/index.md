*[rustls](../../index.md) / [manual](../index.md) / [_06_fips](index.md)*
...
This is [`default_fips_provider()`](#default-fips-provider):
...
See [`CryptoProvider`](rustls/crypto/index.md) documentation for other ways to
specify which `CryptoProvider` to use.

## 3. Validate the FIPS status of your `ClientConfig`/`ServerConfig` at run-time

See [`ClientConfig::fips()`](#fips) or [`ServerConfig::fips()`](#fips).
...
for the [`aws-lc-fips-sys`](#aws-lc-fips-sys) crate.
