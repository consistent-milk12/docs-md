*[rustls](../../index.md) / [manual](../index.md) / [_03_howto](index.md)*
...
[`RUST_LOG`](#rust-log) environment variable to increase the log verbosity. If you're using
...
As one example, on Linux using [`tcpdump`](#tcpdump) is often easiest.
