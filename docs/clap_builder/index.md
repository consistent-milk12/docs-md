...
Create an [`Arg`](index.md) from a usage string.

Allows creation of basic settings for the [`Arg`](index.md).
...
Select a [`ValueParser`](index.md) implementation from the intended type
