...
- `fn clone(self: &Self) -> IdsRef<'a>` — [`IdsRef`](arg_matches/index.md)
...
- `fn clone(self: &Self) -> RawValues<'a>` — [`RawValues`](arg_matches/index.md)
...
- `fn clone(self: &Self) -> Values<T>` — [`Values`](arg_matches/index.md)
...
- `fn clone(self: &Self) -> ValuesRef<'a, T>` — [`ValuesRef`](arg_matches/index.md)
...
- `fn get_subcommand(self: &Self, name: &str) -> Option<&SubCommand>` — [`SubCommand`](arg_matches/index.md)

#### Trait Implementations

##### `impl Clone for ArgMatches`

- `fn clone(self: &Self) -> ArgMatches` — [`ArgMatches`](arg_matches/index.md)
...
- `fn default() -> ArgMatches` — [`ArgMatches`](arg_matches/index.md)

##### `impl Eq for ArgMatches`

##### `impl PartialEq for ArgMatches`

- `fn eq(self: &Self, other: &ArgMatches) -> bool` — [`ArgMatches`](arg_matches/index.md)
...
- `fn clone(self: &Self) -> Indices<'a>` — [`Indices`](arg_matches/index.md)
...
- `fn clone(self: &Self) -> ValueSource` — [`ValueSource`](value_source/index.md)
...
- `fn cmp(self: &Self, other: &ValueSource) -> $crate::cmp::Ordering` — [`ValueSource`](value_source/index.md)

##### `impl PartialEq for ValueSource`

- `fn eq(self: &Self, other: &ValueSource) -> bool` — [`ValueSource`](value_source/index.md)

##### `impl PartialOrd for ValueSource`

- `fn partial_cmp(self: &Self, other: &ValueSource) -> $crate::option::Option<$crate::cmp::Ordering>` — [`ValueSource`](value_source/index.md)
