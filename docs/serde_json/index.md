...
[`serde_json::from_str`][from_str](#from-str) function. There is also [`from_slice`](serde_json/de/index.md)
for parsing from a byte slice `&[u8](#u8)` and [`from_reader`](serde_json/de/index.md) for parsing from
