...
- [`CrateCollection`](#cratecollection): Container for parsed crates with processing order
- [`MultiCrateParser`](#multicrateparser): Scans directories and parses JSON files
- [`UnifiedLinkRegistry`](#unifiedlinkregistry): Cross-crate link resolution
- [`MultiCrateContext`](#multicratecontext): Shared state during generation
- [`MultiCrateGenerator`](#multicrategenerator): Orchestrates per-crate generation
...
Provides an interface similar to [`GeneratorContext`](#generatorcontext) but uses
[`UnifiedLinkRegistry`](#unifiedlinkregistry) for cross-crate link resolution. This
